...
test('one canonical episode counts once with dated and undated evidence',()=>{
 const state={titles:[{id:'show',display_title:'The Great Cleric',media_type:'show'},{id:'excluded',display_title:'One Piece',media_type:'show'}],seasons:[{id:'s1',show_title_id:'show',season_number:1}],episodes:[{id:'e1',season_id:'s1',episode_number:1},{id:'e2',season_id:'s1',episode_number:2}],episode_completion_coverage:[{episode_id:'e1',has_dated_watch:true,has_undated_completion:true}],movie_completion_coverage:[],watch_history:[{episode_id:'e1',watched_at:'2026-09-24T12:00:00Z',source:'manual'},{episode_id:'e1',watched_at:'2026-01-01T12:00:00Z',source:'trakt'}],statuses:[],ratings:[],watchlist:[],verified_season_totals:[{season_id:'s1',episode_total:12}]}
 const ix=buildIndex(state)
 assert.deepEqual(ix.seasonProgress(ix.seasons.get('s1')),{done:1,total:12,recorded:2,kind:'reviewed',planned:null})
 assert.equal(ix.progress(ix.titles[0]).recorded,1)
